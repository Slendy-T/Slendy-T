## Задание 13. Взлом планетной угадайки — 2:
## «Взломайте» guessing_game_2, дописав что-то в пустую строчку.
## Есть дополнительное условие: в команде, которую вы добавите,
## не должно быть слова print.
## Само задание:
...
warning = planet
## Выше я вписываю пустую недостоющую строчку
print(warning)
